...
class RecomFragment : Fragment(), ClickListener {

    private var _binding: FragmentRecomBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRecomBinding.inflate(inflater, container, false)
        return binding.root
    }
